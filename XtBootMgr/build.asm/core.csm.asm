...
Constants:
	...
	.string2: db "", 0Dh, 0Ah, "Version: 0.41.2", 0Dh, 0Ah, "", 0
	...
	.string6: db "-XtBootMgr v0.41.2 [Drive 0x", 0
	.string7: db "]-", 0
	...
	.string11: db "", 0Dh, 0Ah, "Boot signature not found.", 0Dh, 0Ah, "Boot anyway [Enter]?", 0Dh, 0Ah, "", 0
