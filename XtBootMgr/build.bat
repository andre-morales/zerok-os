...
if "%1"=="boot" (
	...
	!CASM! -If ../Libs/casm -i src/boot.csm -tti build/asm/boot.asm -ati build/bin/boot.img -off 0x0 -off 0x0 -len 440 -wt !Disk!
)
if "%1"=="core" (
	...
	!CASM! -If ../Libs/casm -i src/core.csm -tti build/asm/core.asm -ati build/bin/core.img -off 0x0 -off 0x200 -wt !Disk!
)