...
GLOBAL Drive.Init
GLOBAL Drive.ReadSector
GLOBAL Drive.CHS.GetProperties
GLOBAL Drive.LBA.GetProperties

GLOBAL Drive.id
GLOBAL Drive.bufferPtr
GLOBAL Drive.vars_begin
GLOBAL Drive.vars_end
GLOBAL Drive.CHS.bytesPerSector
GLOBAL Drive.CHS.sectorsPerTrack
GLOBAL Drive.CHS.headsPerCylinder
GLOBAL Drive.CHS.cylinders
GLOBAL Drive.LBA.available
GLOBAL Drive.LBA.bytesPerSector
...
Drive.ReadSector: {
	...
	SERIAL_PRINT(."\N[D] R ")
	SERIAL_PRINT_HEX_NUM [$sector_h]
	SERIAL_PRINT(."_")
	SERIAL_PRINT_HEX_NUM [$sector_l]
