...
FATFS.FindFileInDir: {
	...
	.found:
	SERIAL_PRINT(."\N[FS]Located in root")
...
FATFS._TestFileEntry: {
	;SERIAL_PRINT(."\NTest: ")
	;SERIAL_PRINT_HEX_NUM si
	;SERIAL_PRINT(." and ")
	;SERIAL_PRINT_HEX_NUM di
...
FATFS.ReadCluster: {
	...
	SERIAL_PRINT(."\N[FS] Cls ")
	SERIAL_PRINT_HEX_NUM ax
	SERIAL_PRINT(." to ")
	SERIAL_PRINT_HEX_NUM word [Drive.bufferPtr]
...
FATFS.ReadClusterChain: {
	...
	SERIAL_PRINT(."\N[FS] Chain ")
	SERIAL_PRINT_HEX_NUM word [$cluster]
